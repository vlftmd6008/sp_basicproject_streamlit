...
st.write(f"이제 {name}님이 원하시는 매물 가격, 방 개수, 건물 종류, 신축 여부를 입력해주세요.")
y = st.number_input("예산을 숫자로 입력해주세요 (예: 400000000)", value=400000000, step = 100000000)
rooms = st.number_input("방 개수를 숫자로 입력해주세요 (예: 2, 3)", value=3)
usg = st.selectbox("건물 종류를 선택해주세요",
